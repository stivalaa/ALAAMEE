#!/bin/bash
#
# File:    EEestimation2textableMultiModels.sh
# Author:  Alex Stivala
# Created: March 2024
#
# (Copied from estimnetdirectedEstimation2textableMultiModels.sh March 2024)
...
# 
# Usage: EEestimation2textableMultiModels.sh estimationoutputfile_model1 estimationoutputfile_model2 ...
#
# E.g.:
#   EEestimation2textableMultiModels.sh  estimation.out model2/estimation.out
#
# Output is to stdout
#
