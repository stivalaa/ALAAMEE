#!/bin/sh
#
# File:    build_alaamee_estimation_var_total_runs_results_tab.sh
# Author:  Alex Stivala
# Created: May 2023
#
...
# 
# Usage: build_alaamee_estimation_var_total_runs_results_tab.sh joboutputroot
#
# E.g.:
