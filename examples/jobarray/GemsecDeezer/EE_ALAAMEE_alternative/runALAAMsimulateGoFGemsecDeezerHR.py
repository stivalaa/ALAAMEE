#!/usr/bin/env python3
#
# File:    run runALAAMsimulateGoFGemsecDeezerHR.py
# Author:  Alex Stivala
# Created: April 2023
#
...
(paramnames, estimates) = parseEstimationEEOutput('estimation_hr.txt')
...
simulate_from_network_attr(
    ...
    simvecFilePrefix = 'sim_deezer_hr_outcome_alternative'
    )
