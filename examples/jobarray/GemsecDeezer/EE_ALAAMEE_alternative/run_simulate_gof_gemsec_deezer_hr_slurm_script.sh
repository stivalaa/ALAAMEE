...
SIMSTATS_FILE=stats_sim_gof_deezer_hr.txt

# output file of observed ALAAM statistics
OBSTATS_FILE=obs_stats_sim_deezer_hr.txt
...
time python3 ./computeALAAMstatisticsGemsecDeezerHR.py | tee ${OBSTATS_FILE}

time python3 ./runALAAMsimulateGoFGemsecDeezerHR.py  | tee ${SIMSTATS_FILE}
...
Rscript ${ROOT}/R/plotALAAMEEsimFit.R -a -e ../data/deezer_hr_friendship.net ../data/deezer_hr_outcome_alternative.txt sim_deezer_hr_outcome_alternative
