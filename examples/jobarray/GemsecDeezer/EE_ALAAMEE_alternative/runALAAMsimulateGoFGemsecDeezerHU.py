#!/usr/bin/env python3
#
# File:    run runALAAMsimulateGoFGemsecDeezerHU.py
# Author:  Alex Stivala
# Created: April 2023
#
...
(paramnames, estimates) = parseEstimationEEOutput('estimation_hu.txt')
...
simulate_from_network_attr(
    ...
    simvecFilePrefix = 'sim_deezer_hu_outcome_alternative'
    )
