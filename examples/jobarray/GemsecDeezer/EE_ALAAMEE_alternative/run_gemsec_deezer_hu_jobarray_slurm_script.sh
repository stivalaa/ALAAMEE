...
# use the 
# run_submit_gemsec_deezer_hu_process_jobarray_slurm_script.sh
# job to submit this job and then process output with R scripts 
# on completion

#SBATCH --job-name="ALAAMEE_HU_jobarray_parallel"
#SBATCH --time=0-04:00:00
#SBATCH --output=alaamee_GEMSEC_Deezer_HU-%A_%a.out
...
python3 ./runALAAMEEGemsecDeezerHUParallel.py ${SLURM_ARRAY_TASK_ID}
