...
SIMSTATS_FILE=stats_sim_gof_deezer_europe_morestats.txt
...
#      hardcoded in ./runALAAMsimulateGoFDeezerMoreStats.py  script)
time ./runALAAMsimulateGoFDeezerMoreStats.py  | tee ${SIMSTATS_FILE}
