...
param_func_list =        [changeDensity, changeActivity, changeContagion, changeTriangleT1]
labels =                 ["Density",     "Activity",     "Contagion",     "T1"]
...
theta = np.array([-0.1955887, -0.05343727, 0.1140487, -0.001004573])
