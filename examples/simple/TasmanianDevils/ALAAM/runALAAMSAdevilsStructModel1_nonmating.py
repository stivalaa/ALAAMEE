#!/usr/bin/env python3
#
# File:    runALAAMSAdevilsStructModel1_nonmating.py
# Author:  Alex Stivala
...
param_func_list =  [changeDensity, changeActivity, changeContagion, 
                    changePartnerActivityTwoPath, changeTriangleT1,
...
estimateALAAMSA.run_on_network_attr(
        ...
        outcome_bin_filename = 'devils_DFTD_status_nonmating.txt',
        binattr_filename = 'devils_binattr_nonmating.txt',
        contattr_filename = 'devils_contattr_nonmating.txt',
        catattr_filename = 'devils_catattr_nonmating.txt',
        directed = False
    )
