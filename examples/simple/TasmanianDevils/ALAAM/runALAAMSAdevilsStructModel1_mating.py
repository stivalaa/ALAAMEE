#!/usr/bin/env python3
#
# File:    runALAAMSAdevilsStructModel1_mating.py
# Author:  Alex Stivala
...
estimateALAAMSA.run_on_network_attr(
        ...
        outcome_bin_filename = 'devils_DFTD_status_mating.txt',
        binattr_filename = 'devils_binattr_mating.txt',
        contattr_filename = 'devils_contattr_mating.txt',
        catattr_filename = 'devils_catattr_mating.txt',
        directed = False
    )
