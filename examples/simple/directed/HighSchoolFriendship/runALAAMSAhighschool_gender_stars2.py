#!/usr/bin/env python3
#
# File:    runALAAMSAhighschool_gender_stars2.py
# Author:  Alex Stivala
# Created: August 2023
#
...
param_func_list =  [changeDensity, changeSender, changeReceiver, changeEgoInTwoStar, changeEgoInThreeStar, changeEgoOutTwoStar, changeEgoOutThreeStar, changeContagion]
