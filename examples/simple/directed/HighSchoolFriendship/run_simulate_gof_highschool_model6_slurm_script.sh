...
#SBATCH --output=gof_alaam_sim_highschool_model6-%j.out
#SBATCH --error=gof_alaam_sim_highschool_model6-%j.err
#SBATCH --ntasks=1
#SBATCH --mem=4GB
...
Rscript ${ROOT}/R/plotALAAMEEsimFit.R -a ../../../data/directed/HighSchoolFriendship/highschool_friendship_arclist.net ../../../data/directed/HighSchoolFriendship/highschool_friendship_binattr.txt sim_outcome_${modelname}

Rscript ${ROOT}/R/plotALAAMEEvsRandomDegreeDist.R  ../../../data/directed/HighSchoolFriendship/highschool_friendship_arclist.net ../../../data/directed/HighSchoolFriendship/highschool_friendship_binattr.txt sim_outcome_${modelname}
