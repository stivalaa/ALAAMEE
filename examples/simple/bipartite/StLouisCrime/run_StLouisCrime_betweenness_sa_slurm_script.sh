...
#SBATCH --job-name="stochastic_approx_alaam_StLouisCrime_betweenness"
#SBATCH --nodes=1
#SBATCH --cpus-per-task=1
#SBATCH --mem-per-cpu=500MB
#SBATCH --time=0-8:00:00
#SBATCH --output=alaam_sa_stlouiscrime_betweenness-%j.out
#SBATCH --error=alaam_sa_stlouiscrime_betweenness-%j.err
