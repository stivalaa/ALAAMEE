...
ALAAMSASimpleDemo.run_on_network_attr(
    ...
    [changeDensity, changeActivity, changeTwoStar, changeThreeStar, changeContagion, changeTriangleT1, changeTriangleT2, changeTriangleT3, changeIndirectPartnerAttribute, changePartnerAttributeActivity, changePartnerPartnerAttribute, changeoOb, changeo_Ob, changeoOc, changeo_Oc],
    ["Density", "Activity", "Star2", "Star3", "Contagion", "T1", "T2", "T3", "2-Path-Equivalence", "Partner-Attribute-Activity", "Partner-Resource", "senior_oOb", "senior_o_Ob", "age_oOc", "age_o_Oc"],
