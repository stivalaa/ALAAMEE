#!/usr/bin/env python3
#
# File:    runALAAMSASimpleDemoSnowball.py
# Author:  Alex Stivala
# Created: March 2021
#
"""Run the python implementation of the Stochastic
 ...
 Usage:
  runALAAMSASimpleDemoSnowball.py num_waves num_seeds

e.g.

   runALAAMSASimpleDemoSnowball.py 3 10
 ...
 the run_conditional_sa_example.sh script in examples/conditional/.
"""
import getopt
import sys
