...
ALAAMSASimpleDemo.run_on_network_attr(
        'n500_kstar_simulate12750000_waves3_seeds10_num6700000.txt',
        ...
        'sample-n500_bin_cont6700000_waves3_seeds10.txt',
        'binaryAttribute_50_50_n500_waves3_seeds10_num6700000.txt',
        'continuousAttributes_n500_waves3_seeds10_num6700000.txt',
        catattr_filename = None,
        sampler_func = conditionalALAAMsampler,
        zone_filename = 'snowball_zonefile_waves3_seeds10_num6700000.txt')
