...
param_func_list =      [changeDensity, changeLogContagion, changeActivity, changeContagion]
labels =               ["Density",     "LogContagion",     "Activity",     "Contagion"]

theta =       np.array([-0.20,         theta_logcontagion, -0.05,          0])
