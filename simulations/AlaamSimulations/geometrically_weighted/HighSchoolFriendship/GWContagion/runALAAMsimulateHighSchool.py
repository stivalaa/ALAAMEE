...
param_func_list =      [changeDensity, partial(changeGWContagion, log(2.0)),  changeReceiver,  changeSender, changeContagion]
labels =               ["Density",     "GWContagion",                         "Receiver",      "Sender",     "Contagion"]

theta =       np.array([-0.65,         theta_gwcontagion,                      -0.14,          -0.02,        0])
