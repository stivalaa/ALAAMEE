...
param_func_list =      [changeDensity, changeLogContagion,  changeReceiver,  changeSender, changeContagion]
labels =               ["Density",     "LogContagion",      "Receiver",      "Sender",     "Contagion"]

theta =       np.array([-0.65,         theta_logcontagion,   -0.14,          -0.02,        0])
