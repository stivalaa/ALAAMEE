#!/usr/bin/env python3
#
# File:    run runALAAMsimulateDeezer.py
# Author:  Alex Stivala
# Created: July 2023
#
"""Simulate from  Autologistic Actor Attribute Model (ALAAM).

   Usage: runALAAMsimulateDeezer.py TASK_ID
...
param_func_list =      [changeDensity, changeActivity, partial(changeGWContagion, log(2.0)), changeContagion]
labels =               ["Density",     "Activity",     "GWContagion",                        "Contagion"]

theta =       np.array([-0.20,         -0.05,          theta_gwcontagion,                    0])
