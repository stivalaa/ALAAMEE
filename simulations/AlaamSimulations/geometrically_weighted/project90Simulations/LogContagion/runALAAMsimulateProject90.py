...
param_func_list =      [changeDensity, changeActivity,  changeLogContagion, partial(changeoOb, "binattr"), partial(changeoOc, "contattr"), changeContagion]
labels =               ["Density",    "Activity" ,      "LogContagion",     "binattr_oOb",                "contattr_oOc",                  "Contagion"]

theta =       np.array([-15.0,         0.550,           theta_logcontagion, 1.20,                          1.15,                           0])
