...
param_func_list =      [changeDensity, changeSender, changeReceiver, changeLogContagion,  changeContagion]
labels =               ["Density",     "Sender",     "Receiver",     "LogContagion",      "Contagion"]

theta =       np.array([-2.80,         0.001,        -0.001,          theta_logcontagion, 0])
