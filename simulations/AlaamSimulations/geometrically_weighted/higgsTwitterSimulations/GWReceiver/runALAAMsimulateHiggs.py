...
theta_gwreceiver = (TASK_ID - 100) / 100    

# parameters and corresponding labels 
param_func_list =      [changeDensity, partial(changeGWReceiver, log(2.0)),  changeSender,  changeContagion, changeReceiver]
labels =               ["Density",     "GWReceiver",                         "Sender",     "Contagion",      "Receiver"]

theta =       np.array([-2.80,        theta_gwreceiver,                       0.001,         0.01,            0])
