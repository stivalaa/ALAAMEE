...
param_func_list =      [changeDensity, changeSender, changeReceiver, partial(changeGWContagion, log(2.0)), changeContagion]
labels =               ["Density",     "Sender",     "Receiver",     "GWContagion",                        "Contagion"]

theta =       np.array([-2.80,         0.001,        -0.001,          theta_gwcontagion,                   0])
