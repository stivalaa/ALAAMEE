...
theta_gwsender = (TASK_ID - 100) / 100    

# parameters and corresponding labels 
param_func_list =      [changeDensity, partial(changeGWSender, log(2.0)),  changeReceiver,  changeContagion, changeSender]
labels =               ["Density",     "GWSender",                         "Receiver",     "Contagion",      "Sender"]

theta =       np.array([-2.80,        theta_gwsender,                       -0.001,         0.01,            0])
