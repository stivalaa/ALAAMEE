...
#SBATCH --output=alaam_sim_project90noattr-%A_%a.out
#SBATCH --error=alaam_sim_project90noattr-%A_%a.err
#SBATCH --ntasks=1
#SBATCH --mem=500MB
#SBATCH --array=0-300
...
SIMSTATS_FILE=stats_sim_project90noattr_${SLURM_ARRAY_TASK_ID}.txt
...
time ./runALAAMsimulateProject90.py ${SLURM_ARRAY_TASK_ID} > ${SIMSTATS_FILE}
