...
param_func_list =      [changeDensity, changeActivity,  changeContagion, partial(changeoOb, "binattr"), partial(changeoOc, "contattr")]
labels =               ["Density",    "Activity" ,      "Contagion",     "binattr_oOb",                "contattr_oOc"]

theta =       np.array([-15.0,         0.550,           theta_contagion, 1.20,                          1.15])
...
simulate_from_network_attr(
    'data/project90_giantcomponent_edgelist.txt',
    param_func_list,
    labels, 
    theta,
    binattr_filename = 'data/binaryAttribute_50_50_n4430_with_header.txt',
    contattr_filename = 'data/continuousAttributes_n4430_with_header.txt',
    sampler_func = basicALAAMsampler,
