...
theta_twostar = (TASK_ID - 100) / 100    

# parameters and corresponding labels 
param_func_list =      [changeDensity, changeActivity, changeContagion, changeTwoStar]
labels =               ["Density",     "Activity",     "Contagion",     "Two-Star"]

theta =       np.array([-10.0,         0.550,          1.0,              theta_twostar])
